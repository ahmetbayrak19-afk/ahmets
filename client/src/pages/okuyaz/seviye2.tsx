...
export default function Seviye2() {
  const [match, params] = useRoute('/okuyaz/seviye2/:id');
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-white p-4 flex flex-col items-center justify-center text-center">
      <div className="max-w-md w-full space-y-6 border border-dashed border-slate-800 rounded-3xl bg-slate-900/20 p-8">
        <div className="mx-auto w-16 h-16 bg-purple-500/10 rounded-full flex items-center justify-center border border-purple-500/20">
            <Layers className="w-8 h-8 text-purple-400" />
        </div>
        <div>
            <h2 className="text-xl font-bold text-white">2. Seviye</h2>
            <p className="text-slate-400 text-sm mt-2">İleri hece grupları ve birleştirme çalışmaları hazırlanıyor.</p>
        </div>
