...
const CHARACTERS: Character[] = [
  ...
  { id: 'c3', img: c3, hair: 'uzun', glasses: 'gozluksuz', pose: 'ayakta', label: 'Sarı · uzun · gözlüksüz · ayakta' },
  { id: 'c4', img: c4, hair: 'uzun', glasses: 'gozluk', pose: 'otur', label: 'Mor · uzun · gözlük · oturan' },
];
...
function matchCharacter(c: Character, task: DigitalTask): boolean {
  ...
  return !!(task.hair || task.glasses || task.pose);
}
...
export default function Yonerge18({
  ...
  const correctId =
    trial?.mode === 'digital' ? findCorrectId(trial.task) : null;
