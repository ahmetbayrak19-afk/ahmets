        ...
        {phase === 'intro' && (
          <div className="text-center max-w-md animate-in zoom-in-95 duration-300">
            ...
            <p className="text-slate-400 mb-8 text-base md:text-lg leading-relaxed">
              Ekranda sırayla <strong>iki basamaklı</strong> yönergeler belirecek. 
              Öğrenciden her iki adımı da yapmasını isteyin. Toplam <strong>10 komut</strong> sorulacaktır.
            </p>
            <button 
