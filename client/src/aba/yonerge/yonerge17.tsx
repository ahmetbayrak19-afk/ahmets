...
/** 20 karmaşık grup yönergesi — doğal sınıf / kurum dili */
const POOL: Task[] = [
  { id: 'g1', text: 'Herkes ayağa kalkıp alkışlasın' },
  { id: 'g2', text: 'Hepiniz oturun ve ellerinizi masaya koyun' },
  { id: 'g3', text: 'Herkes mavi kalemini çıkarıp deftere yazmaya başlasın' },
  { id: 'g4', text: 'Tüm öğrenciler ayaklarını yere vurup alkış yapsın' },
  { id: 'g5', text: 'Hepiniz büyük kitabı ve kalemlerinizi çıkarın' },
  { id: 'g6', text: 'Herkes ayağa kalkıp bir tur dönsün' },
  { id: 'g7', text: 'Hepiniz ellerinizi yukarı kaldırıp üçe kadar saysın' },
  { id: 'g8', text: 'Herkes sandalyesini çekip otursun' },
  { id: 'g9', text: 'Tüm sınıf alkışlasın sonra sustursun' },
  { id: 'g10', text: 'Herkes çantasından defterini çıkarsın' },
  { id: 'g11', text: 'Hepiniz ayağa kalkıp sıraya girin' },
  { id: 'g12', text: 'Herkes masasını toplasın ve ellerini kaldırsın' },
  { id: 'g13', text: 'Tüm öğrenciler gözlerini kapatsın ve saysın' },
  { id: 'g14', text: 'Herkes kırmızı kalemi alsın ve daire çizsin' },
  { id: 'g15', text: 'Hepiniz ayağa kalkıp sağa dönün' },
  { id: 'g16', text: 'Herkes kitabı kapatsın ve masaya koysun' },
  { id: 'g17', text: 'Tüm sınıf ellerini çırpsın sonra dursun' },
  { id: 'g18', text: 'Herkes ayağa kalkıp sola baksın' },
  { id: 'g19', text: 'Hepiniz defterinizi açıp adınızı yazın' },
  { id: 'g20', text: 'Herkes sandalyede otursun ve sessiz olsun' },
];
...
export default function Yonerge17({
  itemCode = 'YTB 4.6',
  itemText = 'Karmaşık Grup Yönergelerini Takip Etme',
  onClose,
  onComplete,
}: Yonerge17Props) {
