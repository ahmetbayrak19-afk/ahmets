...
export default function Yonerge6({ 
  itemCode = "YTB 2.4", 
  itemText = "Yönerge Verildiğinde Belirli Bir Alana Gitme", 
  onClose, 
  onComplete 
}: Yonerge6Props) {
        ...
        {phase === 'intro' && (
          <div className="text-center max-w-md animate-in zoom-in-95 duration-300">
            ...
            <p className="text-slate-400 mb-8 text-base md:text-lg leading-relaxed">
              Ekranda sırayla <strong>10 yönerge</strong> belirecek. 
              Öğrenciden belirtilen okul alanına gitmesi istenecek.
            </p>
            <button 
