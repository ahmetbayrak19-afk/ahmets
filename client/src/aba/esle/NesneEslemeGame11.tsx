...
// --- RAKAM VERİLERİ ---
const OBJECTS = [
  { id: 'bir', name: 'Bir', src: birImg },
  { id: 'iki', name: 'İki', src: ikiImg },
  { id: 'uc', name: 'Üç', src: ucImg },
  { id: 'dort', name: 'Dört', src: dortImg },
  { id: 'bes', name: 'Beş', src: besImg },
  { id: 'alti', name: 'Altı', src: altiImg },
  { id: 'yedi', name: 'Yedi', src: yediImg },
  { id: 'sekiz', name: 'Sekiz', src: sekizImg },
  { id: 'dokuz', name: 'Dokuz', src: dokuzImg },
  { id: 'sifir', name: 'Sıfır', src: sifirImg },
];
...
export default function NesneEslemeGame11({ mode, onClose, onComplete }: GameProps) {
  // GAME STATES
