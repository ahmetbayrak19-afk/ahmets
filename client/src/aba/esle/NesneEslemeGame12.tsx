...
export default function NesneEslemeGame12({ mode, onClose, onComplete }: GameProps) {
  // GAME STATES
          ...
          <div className="flex flex-col items-center">
            ...
            >
               ...
               <span 
                 style={fontStyle}
                 className={twMerge(
                    "text-[10rem] font-bold text-slate-700 transition-all duration-500 pointer-events-none select-none leading-none pb-4",
                    isMatched ? "scale-125 text-green-600 drop-shadow-xl" : "opacity-90"
                 )}
               >
                 {targetItem.text}
               </span>
              ...
              return (
                <div key={item.id} className="relative flex justify-center items-center h-28 w-full">
                  ...
                  >
                    ...
                    <span 
                        style={fontStyle}
                        className="text-6xl font-bold text-slate-700 pointer-events-none select-none pb-2"
                    >
                        {item.text}
                    </span>
