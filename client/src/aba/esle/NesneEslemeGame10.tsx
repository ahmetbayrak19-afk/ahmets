...
// --- ŞEKİL VERİLERİ ---
const OBJECTS = [
  { id: 'daire', name: 'Daire', src: daireImg },
  { id: 'dikdortgen', name: 'Dikdörtgen', src: dikdortgenImg },
  { id: 'kalp', name: 'Kalp', src: kalpImg },
  { id: 'kare', name: 'Kare', src: kareImg },
  { id: 'ucgen', name: 'Üçgen', src: ucgenImg },
  { id: 'yamuk', name: 'Yamuk', src: yamukImg },
  { id: 'yildiz', name: 'Yıldız', src: yildizImg },
];
...
export default function NesneEslemeGame10({ mode, onClose, onComplete }: GameProps) {
  // GAME STATES
