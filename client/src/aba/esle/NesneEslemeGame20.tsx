...
const clothesModules = import.meta.glob('../../clothes/*.webp', {
  eager: true,
  import: 'default',
  query: '?url',
}) as Record<string, string>;
const vegetableModules = import.meta.glob('../../vegetables/*.webp', {
  eager: true,
  import: 'default',
  query: '?url',
}) as Record<string, string>;
...
const schoolModules = import.meta.glob('../../okulmalzemeleri/*.webp', {
  eager: true,
  import: 'default',
  query: '?url',
}) as Record<string, string>;
...
const foodModules = import.meta.glob('../../temelgidalar/*.webp', {
  eager: true,
  import: 'default',
  query: '?url',
}) as Record<string, string>;
...
const DISPLAY_NAMES: Record<string, string> = {
  ...
  ayi: 'Ayı',
  balik: 'Balık',
  bulasikmakinasi: 'Bulaşık makinesi',
  buzdolabi: 'Buzdolabı',
