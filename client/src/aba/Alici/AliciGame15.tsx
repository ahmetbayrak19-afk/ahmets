...
// ✅ DOĞRU: public/ içindeki dosyaya root'tan eriş
// Dosya konumu: client/public/human.glb
        ...
        <div className="absolute top-20 left-4 right-4 z-50 bg-red-500/90 text-white p-4 rounded-xl flex items-center gap-3 shadow-lg backdrop-blur-md">
          ...
          <div>
            ...
            <p className="text-xs opacity-90">
              Dosya <b>client/public/human.glb</b> konumunda olmalı ve path <b>/human.glb</b> olmalı.
            </p>
          </div>
        </div>
      )}
